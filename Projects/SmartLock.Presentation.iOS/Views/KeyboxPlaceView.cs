...
{
    public partial class KeyboxPlaceView : View<IKeyboxPlaceView>, IKeyboxPlaceView
    {
        ...
        public KeyboxPlaceView(KeyboxPlaceController controller) : base(controller, "KeyboxPlaceView")
        {
        }
